...
LABEL org.label-schema.build-date=${BUILD_DATE} \
      org.label-schema.name="ruby3.0" \
      org.label-schema.description="A Ruby 3.0 image based on Debian sid." \
      ...
      org.opencontainers.image.title="ruby3.0" \
      org.opencontainers.image.description="A Ruby 3.0 image based on Debian sid" \
...
ENV RUBY_VER_NUM="3.0" RUBY_DEBIAN_SUITE="sid"
