...
LABEL org.label-schema.build-date=${BUILD_DATE} \
      org.label-schema.name="ruby2.7" \
      org.label-schema.description="A Ruby 2.7 image based on Debian sid." \
      ...
      org.opencontainers.image.title="ruby2.7" \
      org.opencontainers.image.description="A Ruby 2.7 image based on Debian sid" \
...
ENV RUBY_VER_NUM="2.7" RUBY_DEBIAN_SUITE="sid"
