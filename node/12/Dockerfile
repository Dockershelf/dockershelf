...
LABEL org.label-schema.build-date=${BUILD_DATE} \
      org.label-schema.name="node12" \
      org.label-schema.description="A Node 12 image based on Debian sid." \
      ...
      org.opencontainers.image.title="node12" \
      org.opencontainers.image.description="An Node 12 image based on Debian sid" \
