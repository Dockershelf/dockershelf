...
LABEL org.label-schema.build-date=${BUILD_DATE} \
      org.label-schema.name="node18" \
      org.label-schema.description="A Node 18 image based on Debian sid." \
      ...
      org.opencontainers.image.title="node18" \
      org.opencontainers.image.description="An Node 18 image based on Debian sid" \
