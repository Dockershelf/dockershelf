...
* Adding support for Python 3.13, Node 24 and Go 1.24. [Luis Alejandro Martínez Faneyth]
...
* Adding support for Node 18. [Luis Alejandro Martínez Faneyth]
...
* Removing support for Python 3.8, adding support for 3.7 & 3.11. [Luis Alejandro Martínez Faneyth]
...
* Adding Python 3.7 and Odoo 14 support. [Luis Alejandro Martínez Faneyth]
...
* Adding python3-pygments to latex:full so that pygmentize can work properly (fixes #33). [Luis Alejandro Martínez Faneyth]
...
* Fixing Node images. [Luis Alejandro Martínez Faneyth]
...
* Fixing libgcc1 Debian error (see https://bugs.debian.org/cgi-bin/bugreport.cgi?bug=961990). [Luis Alejandro Martínez Faneyth]
...
* Fixing MOTD behavior. [Luis Alejandro Martínez Faneyth]
...
* Disabling https pn debian mirrors to avoid installing ca-certificates. [Luis Alejandro Martínez Faneyth]
...
* Adding Postgres 12. [Luis Alejandro Martínez Faneyth]

* Adding Bullseye Debian release. [Luis Alejandro Martínez Faneyth]
...
* Updating Node versions. [Luis Alejandro Martínez Faneyth]
...
* Adding docker entrypoint and configuration for Odoo. [Luis Alejandro Martínez Faneyth]
...
* Updating odoo images versions. [Luis Alejandro Martínez Faneyth]

* Adding Odoo image. [Luis Alejandro Martínez Faneyth]
...
* Improving documentation and graphics in general. [Luis Alejandro Martínez Faneyth]

* Improving gitchangelog parsing. [Luis Alejandro Martínez Faneyth]
...
* Adding Python 3.7. [Luis Alejandro Martínez Faneyth]

* Removing python 3.7 because is not stable yet. [Luis Alejandro Martínez Faneyth]
...
* Moving images to a folder. [Luis Alejandro Martínez Faneyth]

* Copy Mongo test files if we are building it. [Luis Alejandro Martínez Faneyth]

* Sorting versions in descending order on .travis.yml. [Luis Alejandro Martínez Faneyth]
...
* Changing the way that python images are built. [Luis Alejandro Martínez Faneyth]

* Changing image maintainer email. [Luis Alejandro Martínez Faneyth]

* Removing unstable versions of Mongo. [Luis Alejandro Martínez Faneyth]

* Changing maintainer email. [Luis Alejandro Martínez Faneyth]

* Removing debian stable python versions. [Luis Alejandro Martínez Faneyth]

* Configuring iproute package for Wheezy and iproute2 for the rest. [Luis Alejandro Martínez Faneyth]

* Adding scripts to automate the generarion of Dockerfiles and Readmes. [Luis Alejandro Martínez Faneyth]
...
* Removing Mongo 3.0 because is too much difficult to make it work and Postgres 12 because is not ready yet. [Luis Alejandro Martínez Faneyth]
...
* Fixing debian stretch test case. [Luis Alejandro martínez Faneyth]
...
* Adding build script for latex image to avoid apt timeouts. [Luis Alejandro Martínez Faneyth]

* Adding routine to avoid errors on downloading packages. [Luis Alejandro Martínez Faneyth]
...
* Updating date on copyright boilerplate. [Luis Alejandro Martínez Faneyth]

* Limiting travis build to develop and master branches. [Luis Alejandro Martínez Faneyth]

* Adding functionality for pushing to an alternate development version tag for when not pushing from master branch. [Luis Alejandro Martínez Faneyth]

* Improving test script. [Luis Alejandro Martínez Faneyth]

* Folder names changed. Correcting. [Luis Alejandro Martínez Faneyth]
...
* Extending no-output restriction to 40min on Travis. [Luis Alejandro Martínez Faneyth]

* Changing tag 2.7+3.5 -> 2.7and3.5 because its invalid. [Luis Alejandro Martínez Faneyth]
...
* Removing reinstall of pip because causes to install a new version on 3.2 image which breaks pip. [Luis Alejandro Martínez Faneyth]
...
* Changing dockershelf/python:2.7and3.5 to dockershelf/python:2.7-3.5 because it was too long. [Luis Alejandro Martínez Faneyth]

* Updating docker hub password. [Luis Alejandro Martínez Faneyth]

* Adding logo. [Luis Alejandro Martínez Faneyth]

* Changing namespace of images from luisalejandro to dockershelf. [Luis Alejandro Martínez Faneyth]
...
* Removing duplicate scripts because they are no longer necessary. [Luis Alejandro Martínez Faneyth]

* Removing duplicate scripts because they are no longer necessary. [Luis Alejandro Martínez Faneyth]

* .travis.yml: Trigger a build on hub.docker.com if the cron tells us to. [Luis Alejandro Martínez Faneyth]
...
* Changing tag 2.7+3.5 -> 2.7and3.5 because its invalid (closes #4). [Luis Alejandro Martínez Faneyth]

* Adding initial codebase for 2.7+3.5 Python image. [Luis Alejandro Martínez Faneyth]

* Fixing sourcing library.sh. [Luis Alejandro Martínez Faneyth]

* Wheezy doesn't build because iproute2 doesn't exist. Replacing with iproute which is a dummy package. [Luis Alejandro Martínez Faneyth]

* Improving discovery and installation of Build-Depends and Depends (closes #1). [Luis Alejandro Martínez Faneyth]

* Fixing luisalejandro/latex build. [Luis Alejandro Martínez Faneyth]

* Fixing luisalejandro/latex build. [Luis Alejandro Martínez Faneyth]

* Improving method for getting Build-Depends and Depends. [Luis Alejandro Martínez Faneyth]
...
* Changing label schema for dockerfiles. [Luis Alejandro Martínez Faneyth]

* .travis.yml: adding POST to MicroBadger API so that they stop being lazy. [Luis Alejandro Martínez Faneyth]
...
* Fixing docker hub password. [Luis Alejandro Martínez Faneyth]
