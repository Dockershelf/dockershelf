...
LABEL org.label-schema.build-date=${BUILD_DATE} \
      org.label-schema.name="latex-full" \
      org.label-schema.description="A Latex (full) image based on Debian sid." \
      ...
      org.opencontainers.image.title="latex-full" \
      org.opencontainers.image.description="A Latex (full) image based on Debian sid" \
