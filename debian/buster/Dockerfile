...
LABEL org.label-schema.build-date=${BUILD_DATE} \
      org.label-schema.name="debian-buster" \
      org.label-schema.description="A Debian buster minimal image built from scratch." \
      ...
      org.opencontainers.image.title="debian-buster" \
      org.opencontainers.image.description="A Debian buster minimal image built from scratch." \
