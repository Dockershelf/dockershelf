...
# Debootstrap needs to mount /proc in the target chroot (systemd 261+
# postinsts require it). Debian Dockerfiles run this step with
# RUN --security=insecure so those mounts are allowed.
