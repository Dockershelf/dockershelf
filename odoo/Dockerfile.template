...
LABEL org.label-schema.build-date=${BUILD_DATE} \
      ...
      org.label-schema.description="An Odoo %%ODOO_VERSION%% image based on Debian %%DEBIAN_RELEASE%%." \
      ...
      org.opencontainers.image.title="odoo%%ODOO_VERSION%%" \
      org.opencontainers.image.description="An Odoo %%ODOO_VERSION%% image based on Debian %%DEBIAN_RELEASE%%." \
