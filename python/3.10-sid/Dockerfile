...
LABEL org.label-schema.build-date=${BUILD_DATE} \
      org.label-schema.name="python3.10" \
      org.label-schema.description="A Python 3.10 image based on Debian sid." \
      ...
      org.opencontainers.image.title="python3.10" \
      org.opencontainers.image.description="A Python 3.10 image based on Debian sid" \
...
ENV PYTHON_VER_NUM="3.10" PYTHON_DEBIAN_SUITE="sid" \
    PYTHONIOENCODING="UTF-8" PYTHONPATH="/usr/lib/python3.10/dist-packages:/usr/lib/python3.10/site-packages"
