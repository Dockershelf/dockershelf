...
LABEL org.label-schema.build-date=${BUILD_DATE} \
      ...
      org.opencontainers.image.title="python%%PYTHON_VERSION%%" \
      org.opencontainers.image.description="A Python %%PYTHON_VERSION%% image based on Debian %%DEBIAN_RELEASE%%" \
...
ENV PYTHON_VER_NUM="%%PYTHON_VERSION%%" PYTHON_DEBIAN_SUITE="%%PYTHON_DEBIAN_SUITE%%" \
    PYTHONIOENCODING="UTF-8" PYTHONPATH="/usr/lib/python%%PYTHON_VERSION%%/dist-packages:/usr/lib/python%%PYTHON_VERSION%%/site-packages"
