...
Each python release is installed from the [Dockershelf APT repository](https://apt.dockershelf.com/dockershelf) as a versioned ``python3.X`` package.
...
4. Configure the Dockershelf APT repository.
5. Install Python.
